# Mansur-Rig
Mansur-Rig is an advanced modular rig builder for Maya, based on a dedicated C++ node library written to allow easy rig setups. A One-Stop-Shop for all of your Rigging needs.
...
* Extract the .zip library to your preferred location.
   ...
   * .../ANY_DIRECTORY
      * .../ANY_DIRECTORY/mansurRig_3.0.0
      * .../ANY_DIRECTORY/mansurRig_3.1.0
      * .../ANY_DIRECTORY/mansurRig_1.2.0
